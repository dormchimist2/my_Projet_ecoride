...
final class Version20250221231850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte (id SERIAL NOT NULL, user_id INT DEFAULT NULL, solde NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CFF65260A76ED395 ON compte (user_id)');
        $this->addSql('CREATE TABLE covoiturage (id SERIAL NOT NULL, user_id INT NOT NULL, voiture_id INT DEFAULT NULL, preference_cdt_id INT DEFAULT NULL, date_depart DATE NOT NULL, heure_depart TIME(0) WITHOUT TIME ZONE NOT NULL, point_depart VARCHAR(50) NOT NULL, date_arrivee DATE NOT NULL, heure_arrivee TIME(0) WITHOUT TIME ZONE NOT NULL, point_arrivee VARCHAR(50) NOT NULL, nb_place INT NOT NULL, prix DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE preference_cdt (id SERIAL NOT NULL, user_id INT DEFAULT NULL, accepte_fumeurs BOOLEAN NOT NULL, accepte_animaux_g BOOLEAN NOT NULL, accepte_animaux_p BOOLEAN NOT NULL, musique_autorisee BOOLEAN NOT NULL, discussion_autorisee BOOLEAN NOT NULL, siege_bebe BOOLEAN NOT NULL, ad_preference VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_13410DECA76ED395 ON preference_cdt (user_id)');
        $this->addSql('CREATE TABLE reservation (id SERIAL NOT NULL, user_id INT NOT NULL, covoiturage_id INT NOT NULL, nb_places INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(20) NOT NULL, total_prix NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE voiture (id SERIAL NOT NULL, user_id INT DEFAULT NULL, marque VARCHAR(50) DEFAULT NULL, modele VARCHAR(100) DEFAULT NULL, couleur VARCHAR(50) DEFAULT NULL, date_matriculation DATE NOT NULL, n_immatriculation VARCHAR(50) NOT NULL, moteur VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E9E2810FA76ED395 ON voiture (user_id)');
        $this->addSql('ALTER TABLE compte ADD CONSTRAINT FK_CFF65260A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE covoiturage ADD CONSTRAINT FK_28C79E89A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE preference_cdt ADD CONSTRAINT FK_13410DECA76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE voiture ADD CONSTRAINT FK_E9E2810FA76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
