...
#[ORM\Table(name: "userx")] // Change le nom de la table en PostgreSQL
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_EMAIL', fields: ['email'])]
class Userx implements UserInterface, PasswordAuthenticatedUserInterface
{
    #[ORM\Id]
     ...
     */
    #[ORM\OneToMany(targetEntity: Voiture::class, mappedBy: 'user', cascade: ['remove'], orphanRemoval: true)]
